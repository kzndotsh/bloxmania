...
if (typeof HTMLUpdateUtility === "undefined") {
  class HTMLUpdateUtility {
    ...
    static updateHTML(targetElement, newHTML, options = {}) {
      const { executeScripts = true, preserveScroll = false, focusElement = null, onComplete = null } = options;
        ...
        .then(() => {
          ...
          if (focusElement) {
            const elementToFocus =
              typeof focusElement === "string" ? targetElement.querySelector(focusElement) : focusElement;
